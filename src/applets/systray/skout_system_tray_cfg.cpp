...
#include "skout_system_tray_cfg.moc"

SkoutSysTrayConfig::SkoutSysTrayConfig(TQWidget *parent, const TQString& cfg)
...
SkoutSysTrayConfig::~SkoutSysTrayConfig()
{
}

void SkoutSysTrayConfig::reset()
{
    m_enableStatus->setChecked(true);
}

void SkoutSysTrayConfig::load()
{
    auto cfg = config();
